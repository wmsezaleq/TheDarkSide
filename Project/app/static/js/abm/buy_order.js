            ...
            <td>
                <div class="row">
                    <div class="col-10 form-group">
                        <input type="text" index="${newIndex}" list="SKUs" name="SKU${newIndex}" data-bs-toggle="tooltip" data-bs-placement="top" title="Saraza" class="form-control input-sm">
                    </div>
...
$(function () {
    ...
    $("#saveNewSKU").click(function(){
        /*
            Primero genero una validación de los datos y 
            después envío la información al servidor para crear este nuevo SKU
        */
