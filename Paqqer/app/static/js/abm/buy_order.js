            ...
            <td>
                <div class="row">
                    <div class="col-10 form-group">
                        <input type="text" index="${newIndex}" list="SKUs" name="SKU${newIndex}" class="form-control input-sm" required>
                    </div>
...
$(function () {
    ...
    $("input[name='providers']").keyup(function(){
        if(providers_list.find(element=>element==$(this).val())){
           $("div[name='providerAdd']").hide(); 
        }
        else{
            $("div[name='providerAdd']").show(); 
        }
    })
